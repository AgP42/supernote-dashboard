...
> Adapted from [Laumss/Inkling](https://github.com/Laumss/Inkling) (MIT License, © 2026 Laumss).
> When this skill and the official docs disagree, the official docs win: https://docs.supernote.com/en
> Full API index: https://docs.supernote.com/llms.txt
